...
const Header: FC<Props> = ({ activeItem, setOpen, route, open, setRoute }) => {
  ...
  useEffect(() => {
    ...
    if (!isLoading && !userData && data === null) {
              ...
              <div className="w-full h-[80px] flex items-center justify-between p-3">
                ...
                <div>
                  <Link href="/">
                    <Image
                      ...
                      width={50}
                      height={25}
                      className="object-contain white:bg-black"
                    />
                  </Link>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  {userData ? (
                    ...
                    <HiOutlineUserCircle
                      size={25}
                      className="block cursor-pointer dark:text-white text-black"
