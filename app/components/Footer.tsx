    ...
    <footer>
      ...
      <div className="w-[95%] 800px:w-full 800px:max-w-[85%] mx-auto px-2 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link
                  href="https://www.github.com/dammy-ventures"
                  className="text-base text-black dark:text-gray-300 dark:hover:text-white"
                >
                  github
                </Link>
          ...
          <div>
            ...
            Call Us: +234 915 444 4915
            </p>
           
            <p className="text-base text-black dark:text-gray-300 dark:hover:text-white pb-2">
            Address:Adekunle Ajasin University Akungba Akoko Ondo State Nigeria.
            </p>
         
            <p className="text-base text-black dark:text-gray-300 dark:hover:text-white  pb-2">
            Mail Us: aaualearnit2025@gmail.com
            </p>
        ...
        <p className="text-center text-black dark:text-white">
          Copyright © 2025 iLEARNIT | All Rights Reserved
        </p>
      </div>
      <br />
    </footer>
